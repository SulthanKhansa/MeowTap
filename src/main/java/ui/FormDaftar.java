...
public class FormDaftar extends JFrame implements I18nService.I18nChangeListener {
    ...
    public void onLanguageChanged() {
        setTitle(I18nService.get("register.title"));
        lblTitle.setText(I18nService.get("register.greeting"));
        lblAppName.setText(I18nService.get("welcome.appname"));
        btnDaftar.setText(I18nService.get("register.btn.register"));
        btnBack.setText(I18nService.get("register.btn.login"));
        txtNama.putClientProperty("JTextField.placeholderText", I18nService.get("register.fullname"));
        txtUsername.putClientProperty("JTextField.placeholderText", I18nService.get("register.username"));
        txtPassword.putClientProperty("JTextField.placeholderText", I18nService.get("register.password"));
    }
    ...
    private void prosesDaftar() {
        ...
        if (nama.isEmpty() || user.isEmpty() || pass.isEmpty()) {
            JOptionPane.showMessageDialog(this, I18nService.get("register.error.empty"));
            return;
        }
        ...
        if (dao.register(newAdmin)) {
            JOptionPane.showMessageDialog(this, I18nService.get("register.success"));
            new FormLogin().setVisible(true);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, I18nService.get("register.error.duplicate"));
        }
    }
    ...
    private void initCustomComponents() {
        ...
        lblTitle = new JLabel(I18nService.get("register.greeting"), SwingConstants.CENTER);
        ...
        btnDaftar = new JButton(I18nService.get("register.btn.register"));
        btnDaftar.addActionListener(e -> prosesDaftar());
        container.add(btnDaftar, new AbsoluteConstraints(350, 400, 310, 50));

        btnBack = new JButton(I18nService.get("register.btn.login"));
    ...
    private void applyTheme() {
        ...
        styleInput(txtNama, I18nService.get("register.fullname"));
        styleInput(txtUsername, I18nService.get("register.username"));
        styleInput(txtPassword, I18nService.get("register.password"));
